        ...
        <div> 
            {content && 
                <div className="py-28">
                    ...
                    <div className="w-9/12 pb-24 border-b-2 border-gray-200 mx-auto h-18 flex justify-start items-center">
                        <div className="inline-block w-5/12 mr-2 h-16 mb-3 rounded">
                            <input className="border-2 border-gray-400 rounded text-md p-4 w-full h-full mr-2" placeholder="Enter your work email"/>
                        </div>
                        <div className="inline-block w-3/12 h-16 mb-3 rounded">
                    ...
                    <div className="w-9/12 mx-auto mt-24 flex justify-between">
                        <div className="w-2/5">
                    ...
                    <div className="mt-16 w-9/12 mx-auto ">
                            <div className="h-60 border-2 border-gray-300 flex justify-center items-center mb-8">
                                <div className="text-navColor text-lgg inline-block mx-auto">{content[5].bannerText}</div>
                            </div>
